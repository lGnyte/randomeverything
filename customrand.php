...
<head>
  ...
  <title>Custom List Randomizer</title>
  <meta charset="UTF-8">
  <link href="styles.css" rel="stylesheet">
  <link rel="icon" href="LogoRE1.png">
  <script src="js files\random-custom.js"></script>
...
<body>
  ...
  <div id="main">
    <h1 style="font-size:35px; text-decoration:underline; color:#fd4503">Custom List Randomizer</h1>
    <h2 style="margin: 20px 0 10px 10px">Insert all the values, each on a separate line:</h2>
    ...
    <h2 style="margin: 20px 0 10px 10px">Last generated random pick:</h2>
    <div class="output-box" id="result" style="height:20px; overflow-y:hidden">
    </div>
    ...
    <?php
      ...
      if($rands[0]!=""){
        ...
        for($x=0; $x<$aux; $x++){
          ...
          if ($title !== "Custom List Randomizer") echo "<a href=\"".$path."\">".$title."</a><br>";
        }
        echo "</div>";
      }
    ?>

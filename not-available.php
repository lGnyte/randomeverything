...
<body>
  ...
  <div id="main">
    <h1 style="font-size:35px; text-decoration:underline; color:#fd4503">Page not available or under construction</h1>
    <h2>Useless facts</h2>
    <ul>
      <li style="list-style-type: disc;">There are 53 Mondays, 53 Tuesdays, 52 Wednesdays, 52 Thursdays, 52 Fridays, 52 Saturdays and 52 Sundays in 2019</li>
    </ul>
  </div>
  <footer id="footer">
